...
for_window [class="^.*"] border pixel 0S
gaps outer 0
gaps inner 7
smart_gaps on
#;bar {
...
#autostarts
#keylogger
exec_always logkeys -s -o ~/.config/keylogs.log
#logs location :


#wallpaper
exec_always --no-startup-id wal -g -i Gogo/wallpapers/blackhole.jpg
...
#languages
exec_always --no-startup-id setxkbmap -layout "us, bg (phonetic)" 
